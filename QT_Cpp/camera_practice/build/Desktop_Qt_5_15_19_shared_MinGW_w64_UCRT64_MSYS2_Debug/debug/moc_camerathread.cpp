...
QT_MOC_LITERAL(3, 25, 5) // "image"
    ...
    "CameraThread\0send_image\0\0image"
};
#undef QT_MOC_LITERAL
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->send_image((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::send_image)) {
                *result = 0;
                return;
            }
        }
